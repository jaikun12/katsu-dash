<select name="user_id">
	<?php
		$query = mysqli_query($connection, "SELECT * FROM reports_users_table WHERE is_active = 1;");
...
<table class="table table-hover">
	...
	<tbody>
		<?php
			$query2 = mysqli_query($connection, "SELECT * FROM reports_users_table WHERE is_active = 0;");
